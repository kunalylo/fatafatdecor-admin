...
import { ChevronLeft, Sparkles, CheckCircle2, Plus, Navigation, ScanFace, Timer, Wallet, CreditCard, Phone } from 'lucide-react'
...
export default function DpOrderScreen() {
  const { dpUser, dpSelectedOrder, setDpSelectedOrder, dpTimerSeconds, dpActiveTimer, setDpActiveTimer, setDpTimerSeconds, dpTimerRef, navigate, showToast, formatTimer } = useApp()
