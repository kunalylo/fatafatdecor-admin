...
import { Sparkles, Loader2, Truck } from 'lucide-react'
...
export default function AuthScreen() {
  const { authMode, setAuthMode, loading, authForm, setAuthForm, handleAuth, handleGoogleAuth, navigate, setAppMode } = useApp()
  return (
