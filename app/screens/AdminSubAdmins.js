...
const PERMISSION_OPTIONS = [
  ...
  { id: 'trending',  label: 'Trending Decor',   desc: 'Manage the Trending Decorations rail on Home' },
  { id: 'festivals', label: 'Trending Hampers', desc: 'Manage the Home hampers carousel + festival landing pages' },
