...
import { ChevronLeft, ScanFace, KeyRound, Loader2, CheckCircle2 } from 'lucide-react'
...
export default function DpVerifyScreen() {
  const { dpSelectedOrder, loading, faceScanImage, setFaceScanImage, otpInput, setOtpInput, dpVideoRef, navigate, startFaceScan, captureFace, submitFaceScan, verifyOtp } = useApp()
