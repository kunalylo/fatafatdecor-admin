    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="glass-floating rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 glass-overlay border-b border-white/40 px-6 py-4 flex items-center justify-between">
          <h3 className="font-display text-2xl text-gray-900">Upload <span className="italic iridescent-text">Reference</span> Design</h3>
          ...
          {!preview ? (
            <div
              ...
              className={`
                ...
                ${dragOver ? 'border-pink-500 bg-pink-50/60' : 'border-white/80 bg-white/50 hover:border-pink-400 hover:bg-pink-50/40'}
              `}
            >
          ...
          {preview && (
            <div className="bg-pink-50 border border-pink-200 rounded-lg p-4">
              ...
              {overrides.base_price && (() => {
                ...
                return (
                  <div className="mt-3 bg-white/70 border border-pink-200 rounded p-2 text-[11px]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white/70 border border-white/80 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-pink-300"
        ...
        <div className="sticky bottom-0 glass-overlay border-t border-white/40 p-4 flex gap-2 justify-end">
          ...
          <button
            ...
            className="btn-primary-luxury px-5 py-2 disabled:opacity-50 text-white text-sm font-semibold rounded-lg flex items-center gap-2"
          >
        ...
        {options.map(([key, label]) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => toggle(key)}
              className={`px-2.5 py-1 rounded-full text-xs font-semibold border transition inline-flex items-center gap-1 ${
                active
                  ? 'btn-primary-luxury border-transparent text-white'
                  : 'bg-white/70 border-white/80 text-gray-700 hover:border-pink-300'
              }`}
            >
              {active ? <Check className="w-3 h-3" /> : null}{label}
            </button>
          )
        })}
      </div>
