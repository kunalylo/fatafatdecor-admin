...
import { ChevronLeft, Timer, CheckCircle2, AlertTriangle } from 'lucide-react'
...
export default function DpActiveJobScreen() {
  const { dpSelectedOrder, setDpSelectedOrder, dpTimerSeconds, setDpTimerSeconds, dpActiveTimer, setDpActiveTimer, dpTimerRef, navigate, showToast, formatTimer } = useApp()
